...
var ApiProvider = (function () {
    ...
    ApiProvider.prototype.request = function () {
    ...
    ApiProvider.prototype.getDashboard = function (id) {
        return this.request().get("/dashboard/" + id).then(function (result) { return result.data; });
    };
    ApiProvider.prototype.createDashboard = function (model) {
        return this.request().post("/dashboard/create", model).then(function (result) { return result.data; });
    };
    ApiProvider.prototype.getMyDashboards = function (query) {
        return this.request().get("/dashboard/my").then(function (result) { return result.data; });
    };
    ...
    ApiProvider.prototype.deleteDashboard = function (id) {
        return this.request().post("/dashboard/delete/" + id).then(function (result) { return result.data; });
    };
    ApiProvider.prototype.saveDashboard = function (id, updateValues) {
        return this.request().post("/dashboard/save/" + id, updateValues).then(function (result) { return result.data; });
    };
    ApiProvider.prototype.createDashlet = function (model) {
        return this.request().post("/dashlet/create", model).then(function (result) { return result.data; });
    };
    ApiProvider.prototype.getDashletsOfDashboard = function (dashboardId) {
        return this.request().get("/dashlet/bydashboard/" + dashboardId).then(function (result) { return result.data; });
    };
    ApiProvider.prototype.deleteDashlet = function (id) {
        return this.request().post("/dashlet/delete/" + id).then(function (result) { return result.data; });
    };
    ApiProvider.prototype.saveDashlet = function (id, updateValues) {
        return this.request().post("/dashlet/save/" + id, updateValues).then(function (result) { return result.data; });
    };
    return ApiProvider;
}());
if (window) {
